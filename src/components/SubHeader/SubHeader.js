            ...
            <div className="mega-menu">
                ...
                <ul className="menu-list">
                    <li className="menu-item list-hover">
                        <button className="menu-hover-button" onClick={() => this.setState({ dropdown: !this.state.dropdown })}> <span className="dropdown-text">All Categories</span> <i className="fa fa-chevron-down" style={{marginLeft:"7px"}} /> </button>
                        <ul className="mega-sub-menu mega-open-menu">
                            <li className="menu-sub-item menu-sub-item-title">
                                <a href="/"><h3 className="menu-sub-heading">Vehicle</h3></a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Mobiles</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Electronics & Home Appliances</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Property for Sale</h3> </a>
                                <ul>
                            ...
                            <li className="menu-sub-item menu-sub-item-title">
                                <a href="/"> <h3 className="menu-sub-heading">Animals</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Furniture & Home Decor</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Business, Industrial & Agriculture</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Bikes</h3> </a>
                                <ul>
                            ...
                            <li className="menu-sub-item menu-sub-item-title">
                                <a href="/"> <h3 className="menu-sub-heading">Fashion & Beauty</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Property For Rent</h3> </a>
                                <ul>
                                    <li className="menu-sub-item-list"><a href="/">Land & Plots</a></li>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Jobs</h3> </a>
                                <ul>
                            ...
                            <li className="menu-sub-item menu-sub-item-title">
                                <a href="/"> <h3 className="menu-sub-heading">Service</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Books, Sports & Hobbies</h3> </a>
                                <ul>
                                ...
                                <a href="/"> <h3 className="menu-sub-heading">Kids</h3> </a>
                                <ul>
